...
const curRating = document.querySelector(
	'.filters > .puzzle-info .puzzle-rating span:last-child'
)
const curThemes = document.querySelector(
	'.filters > .puzzle-info .puzzle-themes span:last-child'
)
...
async function getRandomPuzzle() {
	const response = await fetch(
		`${location.protocol}//${location.host}/puzzle/random/${location.search}`
	)
