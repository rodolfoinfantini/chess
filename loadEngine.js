...
const load_engine = (function () {
    ...
    function spawn_worker(path, options) {
        ...
        engine = spawn(path, args, { stdio: 'pipe' })
    ...
    function new_worker(path, options) {
        ...
        if (
            ...
            return spawn_worker(path || join(__dirname, 'src', 'stockfish.js'), options)
        }
